...
public class DoubleRadarTurret : MonoBehaviour
{
    ...
    void shoot()
    {
        ...
        Wave_Bullet bullet_One = bulletGO_One.GetComponent<Wave_Bullet>();
        Wave_Bullet bullet_Two = bulletGO_Two.GetComponent<Wave_Bullet>();
