...
public class WorthUpBullet : MonoBehaviour
{
    private Transform target;

    public float speed = 70f;
    public int damage = 50;
    public float worthUpPrc = 0.1f;
    ...
    void damageEnemy(Transform enemy)
    {
        ...
        {
            e.takeDamage(damage);
            if (e.worth < e.originalWorth + e.originalWorth * worthUpPrc) 
            {
                e.worth = e.originalWorth + e.originalWorth * worthUpPrc;
            }
        }
    }
